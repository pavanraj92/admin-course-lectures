...
use admin\courses\Models\Transaction;
...
class TransactionManagerController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            return view('course::admin.transaction.index', compact('transactions', 'statuses'));
        } catch (\Exception $e) {
    ...
    public function show(Transaction $transaction)
    {
        try {
            ...
            return view('course::admin.transaction.show', compact('transaction'));
        } catch (\Exception $e) {
